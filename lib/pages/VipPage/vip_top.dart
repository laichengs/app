...
class _VipTopState extends State<VipTop> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        children: <Widget>[
          Image.asset(data[this.widget.currentIndex],
  ...
  _power(){
    List<Map<String,String>> data = [
      {
        "title": '提前预约',
        "url": 'images/vip-page/order.png'
      },
      {
        "title": "专属客服",
        "url": 'images/vip-page/custom.png'
      },     {
        "title": '服务折扣',
        "url": 'images/vip-page/discount.png'
      },     {
        "title": '服务赠送',
        "url": 'images/vip-page/present.png'
      },
    ];
    return Column(
     ...
     children: <Widget>[
       Container(
         margin: EdgeInsets.fromLTRB(0,ScreenUtil().setWidth(30), 0,ScreenUtil().setWidth(30)),
         child: Text("会员特权",textAlign:TextAlign.left,style: TextStyle(
           color: Colors.black,
